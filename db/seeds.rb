...
puts "------------seeding-----------"
user = User.create(email: 'test@test.as', password: 'test123', first_name: 'Tess', last_name: 'Est'. remote_photo_url: pictures[0])
trip = Trip.create(description: 'fint hus', start_date: Date.today.to_s, end_date: (Date.tomorrow + rand(10..50)).to_s, user_id: user.id)
